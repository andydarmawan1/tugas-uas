...
import com.example.utsnabilahra.entities.Pemesan;
import com.example.utsnabilahra.models.PemesanModel;

import java.util.ArrayList;

public class LihatPemesanActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Intent intent = new Intent(this, DetailPemesanActivity.class);
