package com.example.utsnabilahra.libraries;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE IF NOT EXISTS pemesan(id integer PRIMARY KEY, nama VARCHAR, nomor VARCHAR, judul VARCHAR, jumlah VARCHAR)";
        db.execSQL(sql);
    }
